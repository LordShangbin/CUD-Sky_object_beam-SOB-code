...
st = calFunction.getSiderealTime(now)
lst = calFunction.getLocalST(st, long)
hour_angle = calFunction.getHourAngle(lst, ra)
az, al = calFunction.getAltazimuth(la, ra, dec, hour_angle)

#-------------------- Print results --------------------#
stlist = calFunction.decimal_to_arc_hms(st)
ralist = calFunction.decimal_to_arc_hms(ra)
halist = calFunction.decimal_to_arc_hms(hour_angle)
