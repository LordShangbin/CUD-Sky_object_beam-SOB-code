...
#import SOB_hardware_function as hardware
import time
import json
...
#azmotor = hardware.stepper_motor(17, 27, 22, 20, 21, 1200, 2)
#altmotor = hardware.stepper_motor(23, 24, 25, 5, 6, 600, 1)

#-------------------- Load Sky object data --------------------#
# Load the JPL ephemeris DE421 (covers 1900-2050).
folder = "C:\\Users\\Shangbin\\OneDrive\\Documents\\Programming_Stuff\\Python\\Sky object beam\\V.2.1 (terminal version)"

folder2 = "/home/Shangbin/Desktop/V.2.1"
...
filepath = f'{folder}\\Deep_sky_object_data.json'
...
while True:
    ...
    # Deep sky object #
        ...
        # azmotor.driveTo(0, 15)
        # altmotor.driveTo(0, 15)
        pass
    elif inp == "Stop":
        break
    else:
    ...
    # azmotor.lock()
    # altmotor.lock()
    # azmotor.driveFor(az, 15)
    # altmotor.driveFor(al, 15)